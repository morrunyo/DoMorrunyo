...
class ActuatorsControllerTest < ActionController::TestCase
  ...
  test "should create actuator" do
    assert_difference('Actuator.count') do
      post :create, actuator: { actuatorType_id: @actuator.actuatorType_id, name: @actuator.name, node_id: @actuator.node_id }
    end
  ...
  test "should update actuator" do
    patch :update, id: @actuator, actuator: { actuatorType_id: @actuator.actuatorType_id, name: @actuator.name, node_id: @actuator.node_id }
    assert_redirected_to actuator_path(assigns(:actuator))
  end
